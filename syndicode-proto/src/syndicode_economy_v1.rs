...
/// Request message for querying building ownerships.
...
/// Represents detailed information about a building ownership.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct BuildingOwnershipDetails {
    #[prost(string, tag = "1")]
    pub gml_id: ::prost::alloc::string::String,
}
/// Response containing the list of matching building ownership details
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct BuildingOwnershipsResponse {
    /// The tick for which the update is relevant.
    #[prost(int64, tag = "1")]
    pub game_tick: i64,
    #[prost(message, repeated, tag = "2")]
    pub ownerships: ::prost::alloc::vec::Vec<BuildingOwnershipDetails>,
    /// Total number of ownerships matching the criteria
    #[prost(int64, tag = "3")]
    pub total_count: i64,
}
