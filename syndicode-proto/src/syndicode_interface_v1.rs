...
pub mod auth_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("syndicode_interface_v1.AuthService", "VerifyUser"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/syndicode_interface_v1.AuthService/GetCurrentUser",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod auth_service_server {
    ...
    pub trait AuthService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn resend_verification_email(
            &self,
            request: tonic::Request<super::ResendVerificationEmailRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ResendVerificationEmailResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/syndicode_interface_v1.AuthService/VerifyUser" => {
                    #[allow(non_camel_case_types)]
                    struct VerifyUserSvc<T: AuthService>(pub Arc<T>);
                    impl<
                        T: AuthService,
                    ...
                    for VerifyUserSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AuthService>::verify_user(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/syndicode_interface_v1.AuthService/ResendVerificationEmail" => {
                    #[allow(non_camel_case_types)]
                    struct ResendVerificationEmailSvc<T: AuthService>(pub Arc<T>);
                    impl<
                        T: AuthService,
                    > tonic::server::UnaryService<super::ResendVerificationEmailRequest>
                    for ResendVerificationEmailSvc<T> {
                        type Response = super::ResendVerificationEmailResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            request: tonic::Request<
                                super::ResendVerificationEmailRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AuthService>::resend_verification_email(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ResendVerificationEmailSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
...
pub mod admin_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/syndicode_interface_v1.AdminService/GetUser",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("syndicode_interface_v1.AdminService", "GetUser"),
                );
            self.inner.unary(req, path, codec).await
        }
...
pub struct PlayerAction {
    ...
    #[prost(string, tag = "1")]
    pub request_uuid: ::prost::alloc::string::String,
    #[prost(oneof = "player_action::Action", tags = "2, 3, 4, 5, 6, 7")]
...
pub mod player_action {
    ...
    pub enum Action {
        ...
        #[prost(message, tag = "7")]
        QueryBusinesses(super::super::syndicode_economy_v1::QueryBusinessesRequest),
    }
}
...
pub struct GameUpdate {
    ...
    pub game_tick: i64,
    #[prost(
        oneof = "game_update::Update",
        tags = "2, 3, 4, 5, 6, 7, 8, 9, 10, 13, 11, 12"
    )]
...
pub mod game_update {
    ...
    pub enum Update {
        ...
        QueryBusinesses(super::super::syndicode_economy_v1::QueryBusinessesResponse),
...
pub mod economy_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn query_businesses(
            &mut self,
            request: impl tonic::IntoRequest<
                super::super::syndicode_economy_v1::QueryBusinessesRequest,
            >,
        ) -> std::result::Result<
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/syndicode_interface_v1.EconomyService/QueryBusinesses",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn acquire_listed_business(
            &mut self,
            request: impl tonic::IntoRequest<
                super::super::syndicode_economy_v1::AcquireListedBusinessRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::ActionInitResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/syndicode_interface_v1.EconomyService/AcquireListedBusiness",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
/// Generated server implementations.
pub mod economy_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    /// EconomyService provides methods for querying economy-related data.
    #[derive(Debug)]
    pub struct EconomyServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for EconomyServiceServer<T>
    where
        T: EconomyService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/syndicode_interface_v1.EconomyService/QueryBusinesses" => {
                    #[allow(non_camel_case_types)]
                    struct QueryBusinessesSvc<T: EconomyService>(pub Arc<T>);
                    impl<
                        T: EconomyService,
                    > tonic::server::UnaryService<
                        super::super::syndicode_economy_v1::QueryBusinessesRequest,
                    > for QueryBusinessesSvc<T> {
                        type Response = super::super::syndicode_economy_v1::QueryBusinessesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EconomyService>::query_businesses(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/syndicode_interface_v1.EconomyService/AcquireListedBusiness" => {
                    #[allow(non_camel_case_types)]
                    struct AcquireListedBusinessSvc<T: EconomyService>(pub Arc<T>);
                    impl<
                        T: EconomyService,
                    > tonic::server::UnaryService<
                        super::super::syndicode_economy_v1::AcquireListedBusinessRequest,
                    > for AcquireListedBusinessSvc<T> {
                        type Response = super::ActionInitResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EconomyService>::acquire_listed_business(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = AcquireListedBusinessSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for EconomyServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "syndicode_interface_v1.EconomyService";
    impl<T> tonic::server::NamedService for EconomyServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
